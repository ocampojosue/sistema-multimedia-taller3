   ...
   <nav id="compactSidebar">
      ...
      <ul class="menu-categories">
         <li class="menu menu-single">
            <a href="{{route('home')}}" @if (Request::is('/','home')) data-active="true" @endif class="menu-toggle">
               <div class="base-menu">
         ...
         <li class="menu menu-single">
            <a href="#" @if (Request::is('materia','materia/create')) data-active="true" @endif class="menu-toggle">
               <div class="base-menu">
                  <div class="base-icons">
         ...
         <li class="menu">
            <a href="#dashboard" @if (Request::is('dashboard')) data-active="true" @endif class="menu-toggle">
               <div class="base-menu">
                  <div class="base-icons">
                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
         ...
         <li class="menu menu-single">
            <a target="_blank" href="../../documentation/index.html" data-active="false" class="menu-toggle">
               <div class="base-menu">
                  <div class="base-icons">
   ...
   <div id="compact_submenuSidebar" class="submenu-sidebar">
      ...
      <div class="submenu" id="app">
         <ul class="submenu-list" data-parent-element="#app">
            ...
            <li class="sub-submenu">
               <a role="menu" class="collapsed" data-toggle="collapse" data-target="#appInvoice" aria-expanded="true">
                  <div>Invoice</div> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
         ...
         <ul class="submenu-list" data-parent-element="#tables">
            ...
            <li class="sub-submenu">
               <a role="menu" class="collapsed" data-toggle="collapse" data-target="#datatables" aria-expanded="true">
                  <div>Datatables</div> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                     <polyline points="9 18 15 12 9 6"></polyline>
                  </svg>
               </a>
      ...
      <div class="submenu" id="more">
         <ul class="submenu-list" data-parent-element="#more">
            ...
            <li class="sub-submenu">
               <a role="menu" class="collapsed" data-toggle="collapse" data-target="#starter-kit" aria-expanded="true">
